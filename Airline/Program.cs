            ...
            using (StreamReader reader = new StreamReader(path))
            {
                ...
                try
                {
                    ...
                    do
                    {
                        ...
                        int.TryParse(values[2], out int capacity);
                        int.TryParse(values[3], out int carrying);
                        int.TryParse(values[4], out int fuelConsumption);
                        int.TryParse(values[5], out int range);
